<?php 
    ...
    $msql = "SELECT category.name as cat_name,subcategory.id as subcat_id,subcategory.name as subcat_name FROM subcategory RIGHT JOIN category ON subcategory.cat_id=category.id WHERE category.status=1";
